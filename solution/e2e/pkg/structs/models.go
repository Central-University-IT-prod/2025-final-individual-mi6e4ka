...
type Campaign struct {
	...
	ImpressionsLimit  int        `json:"impressions_limit" binding:"required,gtefield=ClicksLimit"`
	ClicksLimit       int        `json:"clicks_limit" binding:"required"`
	...
	EndDate           int        `json:"end_date" binding:"required,gtefield=StartDate"`
...
type Targeting struct {
	...
	AgeFrom  *int    `json:"age_from" binding:"omitempty"`
	AgeTo    *int    `json:"age_to" binding:"omitempty,gtenrfield=AgeFrom"`
